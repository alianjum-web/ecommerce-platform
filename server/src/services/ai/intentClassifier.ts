import { isLeadCaptureTrigger } from "./leadCaptureParser";
import { isOrderSupportQuery } from "./orderSupportParser";
import { isProductRecommendationQuery } from "./recommendationParser";
